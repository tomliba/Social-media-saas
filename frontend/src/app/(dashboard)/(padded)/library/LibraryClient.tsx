...
export default function LibraryClient({
  ...
  // Refresh from the API — used for polling and after mutations. The first
  // render already has server-fetched data (initialItems), so there is no
  // on-mount fetch waterfall here.

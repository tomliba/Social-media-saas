    ...
    <main className="min-h-screen bg-surface flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface-container-lowest rounded-2xl p-10 shadow-[0px_20px_40px_rgba(111,51,213,0.06)] border border-outline-variant/10">
          <h2 className="text-2xl font-bold font-headline text-on-surface text-center mb-2">Welcome back</h2>
          <p className="text-on-surface-variant text-center mb-8">Sign in to continue creating</p>
          ...
          <div className="mt-8 text-center">
            <p className="text-on-surface-variant text-sm">
              ...
              <Link href="/signup" className="text-primary font-bold hover:underline">Sign up free</Link>
            </p>
          </div>
        </div>
